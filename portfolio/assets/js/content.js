  ...
  projects: [
    {
      ...
      layout: "split",
      media: [
        { src: "", label: "[HeatGuard Hero Image]", caption: "HeatGuard", ratio: "3/2" },
        { src: "assets/images/heatguard-wearable.png", label: "[HeatGuard Wearable]", caption: "The upper-arm wearable", alt: "HeatGuard wearable: a black sensor pod on an elastic upper-arm strap", ratio: "3/2" },
    ...
    },
    {
      ...
      layout: "split",
      media: [
        { src: "", label: "[ReSlot Prototype]", caption: "ReSlot", ratio: "10/7" },
        { src: "assets/images/reslot-sustainability-award.jpg", label: "[ReSlot Award]", caption: "Sustainability Practice Award, SUTD Innovating with Design and AI-2", alt: "SUTD certificate of award: Sustainability Practice Award to Cohort 5, Team H: Re-Slot", ratio: "10/7" },
      ...
      results: [
        ...
        { text: "Sustainability Practice Award, SUTD" },
      ],
    ...
    },
    {
      ...
      layout: "split",
      media: [
        { src: "", label: "[Web2API Screenshot]", caption: "Web2API", ratio: "800/1168" },
        { src: "assets/images/web2api-ui.jpg", label: "[Web2API UI]", caption: "Live product extraction → structured table → showcase", alt: "Web2API interface: extracted product table and a generated product showcase", ratio: "800/1168" },
